 ...
 * @author indap.n
 */
public class WorkerPickUpDetailsJPanel extends javax.swing.JPanel {
    ...
    public WorkerPickUpDetailsJPanel(JPanel userProcessContainer, UserAccount account, CollectionWorkRequest request) {
        initComponents();
