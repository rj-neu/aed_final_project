 ...
 * @author indap.n
 */
public class WorkerPickUpJPanel extends javax.swing.JPanel {
    ...
    public WorkerPickUpJPanel(JPanel userProcessContainer, UserAccount account) {
        initComponents();
    ...
    private void btnPickupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPickupActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (request.getStatus().equals(RequestStatus.getPickupStatusMessage(3))) {
                ...
                WorkerPickUpDetailsJPanel logisticsWorkerPickUpDetailsJPanel = new WorkerPickUpDetailsJPanel(userProcessContainer, account, request);
